	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				...
				<c:forEach items="${listBanner}" var="banners">
					<div class="item-slick1"
						style="background-image: url(<c:url value="/assets/images/banner/${banners.link}"></c:url>);">
						<div class="container h-full">
							<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
								<div class="layer-slick1 animated visible-false"
									data-appear="fadeInDown" data-delay="0">
									<span class="ltext-101 cl2 respon2" style="color: #00FF00;">
										Women Collection 2018 </span>
								</div>

								<div class="layer-slick1 animated visible-false"
									data-appear="fadeInUp" data-delay="800">
									<h2 class="ltext-201 cl2 p-t-19 p-b-43 respon1"
										style="color: #00FF00;">NEW SEASON</h2>
								</div>
				...
				<c:forEach items="${listType}" var="types">
					<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
						...
						<div class="block1 wrap-pic-w">
							<a href="<c:url value="/product/view-product/${types.id}" />"><img
								src="<c:url value="/assets/images/type/${types.image_Type.link}"></c:url>"
								alt="IMG-BANNER"></a>
						</div>
					</div>
				</c:forEach>
		...
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<c:forEach items="${listType}" var="types">
						<a href="<c:url value="/product/view-product/${types.id}" />">
							<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
								data-filter="">${types.name}</button>
						</a>
					</c:forEach>
			...
			<!-- SHOW PRODUCT -->
			<div class="row isotope-grid" id="product_load_more">

				<c:forEach items="${listProduct}" var="products">
					<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								...
								<button data-id="${products.id}" data-name="${products.name}"
									class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-addcart-detail addToCart">
									Add to cart</button>
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
									<a
										href="<c:url value="/product-detail/${products.id}"></c:url>"
