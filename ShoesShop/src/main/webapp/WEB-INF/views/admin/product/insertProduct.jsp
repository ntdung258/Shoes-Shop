      ...
      <div class="templatemo-content col-1 light-gray-bg">
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <h2 class="margin-bottom-10">Add new product</h2>
            <span class="mtext-105 cl2 txt-center p-b-30" style="color:red">${error}</span>
            <form:form action="/ShoesShop/admin/add-product" class="templatemo-login-form" method="post" modelAttribute="pro" enctype="multipart/form-data">
              ...
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label>Price</label>
                     <form:input type="number" class="form-control" path="price" placeholder="0.0" /> 
                    <form:errors path="price" style="color:red" />                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label>Amount</label>
                     <form:input type="number" class="form-control" path="amount" placeholder="0" /> 
              ...
              <div class="form-group text-right">
                <button type="submit" class="templatemo-blue-button">Add new</button>
